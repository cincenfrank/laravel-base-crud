...
class ComicsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach ($dataSeed as $comic) {
            # code...
            $newElement = new Comic();
            $newElement->title = $comic["title"];
            $newElement->description = $comic["description"];
            $newElement->thumb = $comic["thumb"];
            $newElement->price = $comic["price"];
            $newElement->series = $comic["series"];
            $newElement->sale_date = $comic["sale_date"];
            $newElement->type = $comic["type"];
            $newElement->save();
        }
    }
}
